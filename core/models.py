...
class TAP_SCHEMA_schemas(models.Model):
    schema_name = models.CharField(primary_key=True, max_length=256)
...
class TAP_SCHEMA_columns(models.Model):
    table_name = models.CharField(primary_key=True, max_length=256)
    column_name = models.CharField(max_length=256)
    datatype = models.CharField(max_length=256)
    arraysize = models.CharField(max_length=256, blank=True, null=True)
    size = models.CharField(max_length=1024, blank=True, null=True)
    description = models.IntegerField(null=True)  # used for sorting tables, 0 = first table, 1 = second table etc.
    utype = models.CharField(max_length=256, blank=True, null=True)
...
class TAP_SCHEMA_keys(models.Model):
    ...
    key_id = models.CharField(primary_key=True, max_length=256)
