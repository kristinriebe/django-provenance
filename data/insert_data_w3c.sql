...
DELETE FROM prov_w3c_activity;
DELETE FROM prov_w3c_entity;
DELETE FROM prov_w3c_used;
DELETE FROM prov_w3c_wasGeneratedBy;
DELETE FROM prov_w3c_agent;
DELETE FROM prov_w3c_agent;
DELETE FROM prov_w3c_wasassociatedwith;
...
INSERT INTO prov_w3c_entity (id, label, type, location, access, size, format, description, docuLink, dataproduct_type, dataproduct_subtype, level) VALUES
...
INSERT INTO prov_w3c_used(activity_id, entity_id, role) VALUES
...
INSERT INTO prov_w3c_wasgeneratedby(entity_id, activity_id, role) VALUES
...
INSERT INTO prov_w3c_agent(id, label, type, description, affiliation) VALUES
...
INSERT INTO prov_w3c_wasassociatedwith(activity_id, agent_id, role) VALUES
...
INSERT INTO prov_w3c_wasattributedto(entity_id, agent_id, role) VALUES
